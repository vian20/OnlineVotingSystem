...
<div class="wrap">
	...
	<h2 style="margin-left:550px;padding-top:10px;">Login to Participate</h2>
    		...
    		<div class="log">
    			...
    			<div class="field">
    				...
    				<label>
      				...
      				<% String huname = (String)session.getAttribute("uname"); %>
      				<input class="inp" type="hidden" name="uname" value="<%=huname%>"/><br/><br/>
    				</label>
 					<br><button class="submit" type="submit">Login to Participate</button>
 				</div>
 				</form>
   			</div>
    </div>
